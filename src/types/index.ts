...
export interface DashboardSettings {
  ...
  lateNightEnabled: boolean;        // show bouncing clock screensaver or screen-off
  ...
  lateNightBrightness: number;      // 0–100, hardware brightness during screen-off (default 0)
